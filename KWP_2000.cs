...
namespace KWP_2000
{
    class KWP_2000_Process
    {
        ...
        {
            byte this_byte;
            //[01:51:41.730] Init - Format 2 - 81 10 F1 81 03 - ok
            //[01:51:41.792] 83 F1 10 C1 EF 8F C3
        ...
        private byte []fixed_response_data = { 0x04, 0x01, 0x15, 0x61, 0x40, 0x85, 0x62, 0x02, 0x30, 0x62, 0xC4, 0x86, 0x62 };
        ...
        private BlockMessage PrepareResponse_ReadDiagnosticTroubleCodesByStatus_OBD(BlockMessage in_msg, ref BlockMessage out_msg)
        {
            ...
            // Format 2
            // FMT
            this_byte = (byte)((((uint)MSG_A1A0_MODE.WITH_ADDRESS_INFO) << 6) | (fixed_response_data.Length) );
            out_msg.SetTA(this_byte);
            out_msg.UpdateCheckSum(this_byte);
            // SA
            this_byte = in_msg.GetSA();
            ...
            out_msg.UpdateCheckSum(this_byte);
            // returning_data
            foreach(byte res in fixed_response_data)
            {
